namespace org.lyricwiki.www.service
{
    ...
    [System.Xml.Serialization.SoapIncludeAttribute(typeof(AlbumData))]
    [System.Xml.Serialization.SoapIncludeAttribute(typeof(AlbumResult))]
    public partial class LyricWiki : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public LyricWiki()
        {
            this.Url = "http://lyricwiki.org/server.php";
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BegincheckSongExists(string artist, string song, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("checkSongExists", new object[] {
                    artist,
                    song}, callback, asyncState);
        }

        /// <remarks/>
        public bool EndcheckSongExists(System.IAsyncResult asyncResult)
        {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsearchArtists(string searchString, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("searchArtists", new object[] {
                    searchString}, callback, asyncState);
        }

        /// <remarks/>
        public string[] EndsearchArtists(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((string[])(results[0]));
        }
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public AlbumResult[] searchAlbums(string artist, string album, int year)
        {
            object[] results = this.Invoke("searchAlbums", new object[] {
                    artist,
                    album,
                    year});
            return ((AlbumResult[])(results[0]));
        }

        /// <remarks/>
        public System.IAsyncResult BeginsearchAlbums(string artist, string album, int year, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("searchAlbums", new object[] {
                    artist,
                    album,
        ...
        /// <remarks/>
        public AlbumResult[] EndsearchAlbums(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((AlbumResult[])(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsearchSongs(string artist, string song, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("searchSongs", new object[] {
                    artist,
                    song}, callback, asyncState);
        }

        /// <remarks/>
        public SongResult EndsearchSongs(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((SongResult)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BegingetSOTD(System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("getSOTD", new object[0], callback, asyncState);
        }

        /// <remarks/>
        public SOTDResult EndgetSOTD(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((SOTDResult)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BegingetSong(string artist, string song, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("getSong", new object[] {
                    artist,
                    song}, callback, asyncState);
        }

        /// <remarks/>
        public LyricsResult EndgetSong(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((LyricsResult)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BegingetSongResult(string artist, string song, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("getSongResult", new object[] {
                    artist,
                    song}, callback, asyncState);
        }

        /// <remarks/>
        public LyricsResult EndgetSongResult(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((LyricsResult)(results[0]));
        }
        ...
        public AlbumData[] getArtist(ref string artist)
        {
        ...
        /// <remarks/>
        public System.IAsyncResult BegingetArtist(string artist, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("getArtist", new object[] {
                    artist}, callback, asyncState);
        }

        /// <remarks/>
        public AlbumData[] EndgetArtist(System.IAsyncResult asyncResult, out string artist)
        {
            object[] results = this.EndInvoke(asyncResult);
            artist = ((string)(results[1]));
            return ((AlbumData[])(results[0]));
        ...
        /// <remarks/>
        public System.IAsyncResult BegingetAlbum(string artist, string album, int year, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("getAlbum", new object[] {
                    artist,
                    album,
                    year}, callback, asyncState);
        }
        ...
        /// <remarks/>
        public string EndgetAlbum(System.IAsyncResult asyncResult, out string artist, out string album, out int year, out string[] songs)
        {
            object[] results = this.EndInvoke(asyncResult);
            artist = ((string)(results[1]));
            album = ((string)(results[2]));
        ...
        /// <remarks/>
        public System.IAsyncResult BegingetHometown(string artist, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("getHometown", new object[] {
                    artist}, callback, asyncState);
        }

        /// <remarks/>
        public string EndgetHometown(System.IAsyncResult asyncResult, out string state, out string hometown)
        {
            object[] results = this.EndInvoke(asyncResult);
            state = ((string)(results[1]));
            hometown = ((string)(results[2]));
        ...
        public bool postArtist(bool overwriteIfExists, ref string artist, AlbumData[] albums, out string message)
        {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginpostArtist(bool overwriteIfExists, string artist, AlbumData[] albums, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("postArtist", new object[] {
                    overwriteIfExists,
                    artist,
                    albums}, callback, asyncState);
        }

        /// <remarks/>
        public bool EndpostArtist(System.IAsyncResult asyncResult, out string artist, out string message)
        {
            object[] results = this.EndInvoke(asyncResult);
            artist = ((string)(results[1]));
            message = ((string)(results[2]));
        ...
        /// <remarks/>
        public void postArtistAsync(bool overwriteIfExists, string artist, AlbumData[] albums)
        {
            this.postArtistAsync(overwriteIfExists, artist, albums, null);
        }

        /// <remarks/>
        public void postArtistAsync(bool overwriteIfExists, string artist, AlbumData[] albums, object userState)
        {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginpostAlbum(bool overwriteIfExists, string artist, string album, int year, string asin, string[] songs, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("postAlbum", new object[] {
                    overwriteIfExists,
                    artist,
                    album,
                    year,
                    asin,
                    songs}, callback, asyncState);
        }

        /// <remarks/>
        public bool EndpostAlbum(System.IAsyncResult asyncResult, out string artist, out string album, out int year, out string message)
        {
            object[] results = this.EndInvoke(asyncResult);
            artist = ((string)(results[1]));
            album = ((string)(results[2]));
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("dataUsed")]
        public bool postSong(bool overwriteIfExists, ref string artist, ref string song, string lyrics, AlbumResult[] onAlbums, out string message)
        {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginpostSong(bool overwriteIfExists, string artist, string song, string lyrics, AlbumResult[] onAlbums, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("postSong", new object[] {
                    overwriteIfExists,
                    artist,
                    song,
                    lyrics,
                    onAlbums}, callback, asyncState);
        }

        /// <remarks/>
        public bool EndpostSong(System.IAsyncResult asyncResult, out string artist, out string song, out string message)
        {
            object[] results = this.EndInvoke(asyncResult);
            artist = ((string)(results[1]));
            song = ((string)(results[2]));
        ...
        /// <remarks/>
        public void postSongAsync(bool overwriteIfExists, string artist, string song, string lyrics, AlbumResult[] onAlbums)
        {
            this.postSongAsync(overwriteIfExists, artist, song, lyrics, onAlbums, null);
        }

        /// <remarks/>
        public void postSongAsync(bool overwriteIfExists, string artist, string song, string lyrics, AlbumResult[] onAlbums, object userState)
        {
        ...
        /// <remarks/>
        public bool EndpostSong_flags(System.IAsyncResult asyncResult, out string artist, out string song, out string message)
        {
            object[] results = this.EndInvoke(asyncResult);
            artist = ((string)(results[1]));
            song = ((string)(results[2]));
    ...
    public partial class AlbumData
    {
        ...
        private string amazonLinkField;
        ...
        public string amazonLink
        {
            get
            {
                return this.amazonLinkField;
            }
            set
            {
                this.amazonLinkField = value;
            }
        }
    ...
    public partial class searchAlbumsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        ...
        /// <remarks/>
        public AlbumResult[] Result
        {
            get
            {
                this.RaiseExceptionIfNecessary();
                return ((AlbumResult[])(this.results[0]));
            }
        }
    }
    ...
    public partial class getArtistCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        ...
        /// <remarks/>
        public AlbumData[] Result
        {
            get
            {
                this.RaiseExceptionIfNecessary();
                return ((AlbumData[])(this.results[0]));
            }
        }
